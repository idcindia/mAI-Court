...
const cases = [
  {
    ...
    emoji: "⚖️",
    path: "https://www.sci.gov.in/case-status-case-no/",  // Add path for navigation
  },
  {
    title: "High Court Cases",
    description: "Details about High Court cases.",
    emoji: "🏛️",
    path: "https://ecourts.gov.in/ecourts_home/static/highcourts.php",  // Add path for navigation
  },
  {
  ...
  },
  {
    ...
    emoji: "🛍️",
    path: "https://consumeraffairs.nic.in/organisation-and-units/division/legal-metrology/court-cases-and-judgements/court-cases-and-judgements",  // Add path for navigation
  },
];
